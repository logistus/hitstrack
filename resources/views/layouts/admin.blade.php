    ...
    <flux:sidebar collapsible="mobile" sticky class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900/95">
        ...
        <flux:sidebar.nav>
            <flux:sidebar.group :heading="__('Admin')">
                <flux:sidebar.item :href="route('admin.dashboard')" icon="home" :current="request()->routeIs('admin.dashboard')" wire:navigate>
                    {{ __('Dashboard') }}
                </flux:sidebar.item>
            ...
            <flux:sidebar.group :heading="__('App')">
                <flux:sidebar.item :href="route('dashboard')" icon="arrow-left" :current="false" wire:navigate>
                    {{ __('Back to App') }}
                </flux:sidebar.item>
            </flux:sidebar.group>
        </flux:sidebar.nav>
        ...
        @persist('admin-appearance-switch')
        <div
            x-data="{
